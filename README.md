# CatPilot <img src="https://github.com/diemonic1/CatPilot/blob/main/CatPilot.ico?raw=true" width="80" alt="CatPilot - free open source Windows remote control and automation app (VBS scripts, HTTP webhooks, Telegram bot)" />
